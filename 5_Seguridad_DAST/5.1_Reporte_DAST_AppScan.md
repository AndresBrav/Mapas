...
| Info | Informational | http://host.docker.internal:3050 | Percentage of responses with status code 2xx | 100 % |
| Info | Informational | http://host.docker.internal:3050 | Percentage of endpoints with content type text/html | 100 % |
| Info | Informational | http://host.docker.internal:3050 | Percentage of endpoints with method GET | 100 % |
| Info | Informational | http://host.docker.internal:3050 | Count of total endpoints | 1    |
...
* URL: http://host.docker.internal:3050/api-docs/swagger.json
  * Node Name: `http://host.docker.internal:3050/api-docs/swagger.json`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
